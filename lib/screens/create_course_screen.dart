...
import 'dart:io';
import 'course_structure_screen.dart';
...
class _CreateCourseScreenState extends State<CreateCourseScreen> {
  ...
  Future<void> _pickImage() async {
    final XFile? selected = await _picker.pickImage(
      ...
      imageQuality: 70, // Optimización de peso
    );
    if (selected != null) {
  ...
  Future<String?> _uploadImage(String userId) async {
    ...
    try {
      ...
      await supabase.storage.from('miniaturas').upload(
        filePath,
        file,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(_subtituloController, "Describe de qué trata el curso...", maxLines: 3),
            ...
            // Precio y Ofertas
            _buildLabel("Configuración de Precio"),
            _buildPriceField(),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: CustomPaint(
          ...
          child: (_imageFile == null && _existingThumbnailUrl == null) 
            ? Column(
